...
contract HealeShipmentToken is ERC721URIStorage, Ownable {
    string private constant TOKEN_NAME = "HEALE: Shipment Token";
    string private constant TOKEN_SYMBOL = "HSHIPID";
