...
contract HealeProductToken is ERC721URIStorage, Ownable {
    string private constant TOKEN_NAME = "HEALE: Product Token";
    string private constant TOKEN_SYMBOL = "HPRODID";
