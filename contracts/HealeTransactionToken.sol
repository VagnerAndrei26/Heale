...
contract HealeTransactionToken is ERC721URIStorage, Ownable {
    string private constant TOKEN_NAME = "HEALE: Transaction Token";
    string private constant TOKEN_SYMBOL = "HTXID";
