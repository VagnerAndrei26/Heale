...
contract HealeEquipmentToken is ERC721URIStorage, Ownable {
    string private constant TOKEN_NAME = "HEALE: Equipment Token";
    string private constant TOKEN_SYMBOL = "HEQUIPID";
