...
contract HealeInvoiceToken is ERC721URIStorage, Ownable {
    string private constant TOKEN_NAME = "HEALE: Invoice Token";
    string private constant TOKEN_SYMBOL = "HINVID";
