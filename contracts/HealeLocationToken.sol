...
contract HealeLocationToken is ERC721URIStorage, Ownable {
    string private constant TOKEN_NAME = "HEALE: Location Token";
    string private constant TOKEN_SYMBOL = "HELOCID";
