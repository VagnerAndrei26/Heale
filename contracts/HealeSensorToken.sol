...
contract HealeSensorToken is ERC721URIStorage, Ownable {
    string private constant TOKEN_NAME = "HEALE: Sensor Token";
    string private constant TOKEN_SYMBOL = "HSENSORID";
